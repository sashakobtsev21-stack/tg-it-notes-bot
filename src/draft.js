...
Примеры выше настоящие, но два их свойства СПЕЦИАЛЬНО не копируй, даже
если это противоречит примерам:
...
В ОТВЕТЕ — ТОЛЬКО готовый текст поста целиком, без единого слова до или
после него: без заголовков вроде "Черновик:", без чек-листа самопроверки,
без комментариев в духе "Looks solid!" или "вот пост с учётом правил".
Первый символ ответа — первый символ поста, последний символ ответа —
последний символ поста (строка "Подписывайся: ...").`;
}
